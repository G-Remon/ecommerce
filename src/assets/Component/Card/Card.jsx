...
export default function Card(productInfo) {
    ...
    return (
        <div className='card bg-white shadow-2xl rounded-md overflow-hidden'>
            <div className='relative group'>
                <img className='w-full object-cover' src={imageCover} alt='Product' />
                <div className='absolute inset-0 bg-gray-500/40 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-4 transition-opacity '>
                    ...
                    <ShoppingCart
                        className='bg-[#0aad0a] text-white w-8 h-8 cursor-pointer rounded-full hover:bg-white hover:text-[#0aad0a] transition-all p-2'
            ...
            <div className='under text flex justify-between items-center p-4'>
                <h3>{price} EGY</h3>
